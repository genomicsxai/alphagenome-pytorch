...
def train_epoch(
    ...
    Supports single or multiple modality heads, DDP, profiling, gradient
    accumulation, and frozen backbone optimization.
...
def validate(
    ...
    Supports single or multiple modality heads, DDP, and Pearson R metrics.

    Args:
        model: AlphaGenome trunk model (may be DDP-wrapped).
        heads: Dict mapping modality name to output head module (single head OK).
